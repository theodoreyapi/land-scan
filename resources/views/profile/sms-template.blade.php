                    ...
                    <div class="card-body">
                        <div class="d-flex flex-column list-group settings-list">
                            ...
                            <a href="sms-settings.html" class="d-inline-flex align-items-center rounded py-2 px-3">SMS
                                Settings</a>
                            <a href="sms-template.html" class="d-inline-flex align-items-center rounded active py-2 px-3"><i
                    ...
                    <div class="card-body">
                        <div class="border-bottom d-flex align-items-center justify-content-between pb-3 mb-3">
                            ...
                            <a href="#" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#smstemplate"><i class="ti ti-circle-plus me-2"></i>Add
                                Template</a>
                        </div>
                    ...
                    <div class="modal-body pb-0">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="form-label">Template Content</label>
                                    <div class="summernote">Lorem ipsum dolor sit amet consectetur, adipisicing
                                        elit.</div>
                                </div>
                            </div>
                            <div class="col-md-12">

...
$(document).ready(function () {
  ...
  if ($('#s-col-stacked').length > 0) {
    var sColStacked = {
      ...
      colors: ['#4E81EE', '#E70D0D', '#03C95A', '#1B84FF'],
      series: [{
        name: 'PRODUCT A',
  ...
  if ($('#leaves_chart').length > 0) {
    var donutChart = {
      ...
      colors: ['#4E81EE', '#FFC107', '#E70D0D', '#03C95A', '#0C4B5E'],
      responsive: [{
        breakpoint: 480,
        options: {
          chart: {
...
if ($('#leave-report').length > 0) {
  var options = {
    ...
    colors: ['#03C95A', '#FFC107', '#0C4B5E', '#4E81EE'], // Set your colors here
    dataLabels: {
      enabled: false // Disable data labels
    }
  };
    ...
    plotOptions: {
      bar: {
        ...
        colors: {
          ...
          hover: {
            enabled: true,
            borderColor: '#4E81EE', // Color when hovering over the bar
          }
        }
      },
    },
...
chart.render();
 ...
 if ($('#donut-chart-3').length > 0) {
  var options = {
    ...
    colors: ['#4E81EE', '#FFC107', '#E70D0D', '#1B84FF' , '#0C4B5E'], // Colors from the image
    plotOptions: {
        pie: {
            donut: {
                size: '60%',
